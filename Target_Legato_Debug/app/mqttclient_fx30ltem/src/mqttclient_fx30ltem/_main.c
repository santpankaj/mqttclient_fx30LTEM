...
// Startup code for the executable 'mqttclient_fx30ltem'.
...
LE_SHARED const char* _mqttclient_fx30ltemComponent_le_data_ServiceInstanceName = "mqttclient_fx30ltem.mqttclient_fx30ltemComponent.le_data";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t mqttclient_fx30ltem_exe_LogSession;
LE_SHARED le_log_Level_t* mqttclient_fx30ltem_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    mqttclient_fx30ltem_exe_LogSession = log_RegComponent("mqttclient_fx30ltem_exe", &mqttclient_fx30ltem_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_mqttclient_fx30ltemComponent.so");
